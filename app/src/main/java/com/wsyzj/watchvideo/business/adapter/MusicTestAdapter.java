...
public class MusicTestAdapter extends BaseQuickAdapter<Music.SongListBean, BaseViewHolder> {
    private Context mContext;

    public MusicTestAdapter(Context context, @LayoutRes int layoutResId, @Nullable List<Music.SongListBean> data) {
