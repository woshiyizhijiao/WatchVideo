...
public class MusicTestFragment extends BaseFragment implements MusicTestContract.View, SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.OnItemClickListener,
    ...
    private MusicTestPresenter mPresenter;
    private MusicTestAdapter mAdapter;
    ...
    protected BasePresenter presenter() {
        mPresenter = new MusicTestPresenter(this);
        return mPresenter;
    }

    @Override
    public int contentView() {
        return R.layout.fragment_music_test;
    }
    ...
    public void setMusicList(List<Music.SongListBean> musicList) {
        if (mAdapter == null) {
            mAdapter = new MusicTestAdapter(mActivity, R.layout.item_music_test_adapter, musicList);
