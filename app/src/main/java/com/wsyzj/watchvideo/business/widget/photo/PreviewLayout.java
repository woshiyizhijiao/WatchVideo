package com.wsyzj.watchvideo.business.widget.photo;
...
public class PreviewLayout extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public List<Gank.ResultsBean> mThumbViewInfoList = new ArrayList<>();
    ...
    public PreviewLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.layout_preview_photo, this, true);
    ...
    public void setData(List<Gank.ResultsBean> list, int index) {
        ...
        this.mIndex = index;
        mStartBounds = mThumbViewInfoList.get(mIndex).bounds;
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                Glide.with(getContext()).load(mThumbViewInfoList.get(mIndex).url).into(mScalableImageView);
            }
        });
    }
    ...
    private class ImagePagerAdapter extends PagerAdapter {
        ...
        public View instantiateItem(final ViewGroup container, final int position) {
            ...
            Glide.with(getContext()).load(mThumbViewInfoList.get(position).url).into(photoView);
